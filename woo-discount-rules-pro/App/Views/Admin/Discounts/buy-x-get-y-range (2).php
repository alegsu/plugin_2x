            ...
            <div class="wdr-buyx-gety-discount-inner wdr-input-filed-hight" style="border-bottom:1px solid #ddd">
               ...
               <fieldset>
                ...
                <div class="awdr-gety-value"
                    ...
                    >
                    <span class="wdr_desc_text"><?php echo (isset($buyx_gety_adjustment->free_type) && $buyx_gety_adjustment->free_type == 'flat') ? esc_html__('Discount value ', 'woo-discount-rules-pro') : esc_html__('Discount value', 'woo-discount-rules-pro'); ?></span>
                </div>
