...
class Rule
{
     ...
     * @param $value
     * @return float|int
     * Supports multiple discount types including fixed_price for BXGY rules
     * @param $type string Discount type: 'fixed_price', 'percentage', 'flat'
     * @param $original_value float Original price of the product
     * @param $value float Discount value or target price (for fixed_price)
     * @return float|int Calculated discount amount
     */
    function calculator($type, $original_value, $value)
    {
        ...
        switch ($type) {
            case 'fixed_price':
                // Set product to a fixed price (e.g., 1 euro for BXGY rules)
                // Calculate discount as difference between original and target price
